        ...
        buttons.forEach((button, index) => {
            ...
            button.addEventListener("click", (e) => {
                if (button.querySelector(".rmv_pj")) {
                    (0,_render_page__WEBPACK_IMPORTED_MODULE_1__.render_page)(button.querySelector("div").textContent);
                    return;
                }

                (0,_render_page__WEBPACK_IMPORTED_MODULE_1__.render_page)(button.textContent);
            });
    ...
    const remove_project = function () {
        ...
        rmv_pj_btns.forEach((button) => {
            button.addEventListener("click", (e) => {
                ...
                _new_todo__WEBPACK_IMPORTED_MODULE_0__.projects.splice(pj_id, 1);
                setTimeout(() => {
                    (0,_render_page__WEBPACK_IMPORTED_MODULE_1__.render_page)("All");
                }, 50);
            });
        });
    };
